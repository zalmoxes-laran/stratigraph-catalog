...
const STRINGS = {
  en: {
    ...
    "signout": "Sign out",
    "signedin": "signed in",
    "noOidc": "This catalogue checks no tokens (dev mode): there is nobody to be, so nothing here can be withdrawn.",
    "session.incomplete": "The sign-in did not complete: {error}",
    "study.withdraw": "Withdraw",
    "study.withdraw.title": "Remove this study from the catalogue: the container AND its card. This cannot be undone.",
    "study.withdraw.ask": "Withdraw this study from the catalogue?",
    "study.withdrawn": "Withdrawn: {id}",
    "study.withdraw.failed": "Not withdrawn: {error}",
  ...
  it: {
    ...
    "signout": "Esci",
    "signedin": "sei dentro",
    "noOidc": "Questo catalogo non controlla token (modo sviluppo): non c'è nessuno da essere, quindi da qui non si ritira niente.",
    "session.incomplete": "L'accesso non è andato a termine: {error}",
    "study.withdraw": "Ritira",
    "study.withdraw.title": "Togli questo studio dal catalogo: il contenitore E la sua scheda. Non si torna indietro.",
    "study.withdraw.ask": "Ritiro questo studio dal catalogo?",
    "study.withdrawn": "Ritirato: {id}",
    "study.withdraw.failed": "Non ritirato: {error}",
